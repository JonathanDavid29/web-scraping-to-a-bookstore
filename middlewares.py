...
class UltimatescraperSpiderMiddleware:
...
class UltimatescraperDownloaderMiddleware:
    # Not all methods need to be defined. If a method is not defined,
...
class ScrapeOpsFakeUserAgentMiddleware:
    ...
    @classmethod # Nos permite inicializar nuestra clase
    def from_crawler(cls, crawler):
...
## This new middleware goiing to create a new header every time using the data that it gets back from the fake header browser end-point
